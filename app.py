...
def predict():
    if request.method == 'POST':
        ...
        input_data = np.array([[ fixed_acidity, volatile_acidity, citric_acid, residual_sugar, chlorides, free_sd, total_sd, density, ph, sulphates, alcohol]])
